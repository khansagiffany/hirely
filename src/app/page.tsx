        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
            {[
              ...
              { icon: Bell, label: 'Job To-Do', desc: 'Real-time To Do for new opportunities matching your profile.', color: 'from-orange-600 to-yellow-600', bg: 'from-orange-50 to-yellow-50', border: 'border-orange-100', href: '/tasks' },
              { icon: CheckCircle, label: 'One-Click Apply', desc: 'Apply to multiple jobs quickly with one click and track progress.', color: 'from-green-600 to-emerald-600', bg: 'from-green-50 to-emerald-50', border: 'border-green-100', href: '/jobs' },
